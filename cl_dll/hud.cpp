...
hud_origin_x = gEngfuncs.pfnRegisterVariable("hud_origin_x","1",FCVAR_ARCHIVE);
hud_origin_x_pos = gEngfuncs.pfnRegisterVariable("hud_origin_x_pos","0",FCVAR_ARCHIVE);
hud_origin_y = gEngfuncs.pfnRegisterVariable("hud_origin_y","1",FCVAR_ARCHIVE);
hud_origin_y_pos = gEngfuncs.pfnRegisterVariable("hud_origin_y_pos","0",FCVAR_ARCHIVE);
hud_origin_z = gEngfuncs.pfnRegisterVariable("hud_origin_z","1",FCVAR_ARCHIVE);
