...
void EV_GrenadeFire( struct event_args_s *args  );
...
float g_fGrenTime = 0.0;
bool g_bTimer = false;

void EV_GrenadeFire (event_args_t *args)
{
	int idx;
...
void EV_SpinGauss( event_args_t *args )
{
	...
	VectorCopy( args->angles, g_vecPlayerAngle);
	VectorCopy( args->velocity, g_vecPlayerVelocity);
