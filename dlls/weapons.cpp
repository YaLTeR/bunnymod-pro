...
// YaLTeR
DLL_GLOBAL short g_sModelIndexNull; // Holds the index for the null sprite
...
void W_Precache(void)
{
	...
	// YaLTeR
	g_sModelIndexNull = PRECACHE_MODEL ("sprites/null.spr"); // Null sprite
...
TYPEDESCRIPTION	CGauss::m_SaveData[] = 
{
	...
	DEFINE_FIELD(CGauss,pitch,FIELD_INTEGER),
	DEFINE_FIELD(CGauss,m_iSoundState,FIELD_INTEGER),
