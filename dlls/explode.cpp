...
{ 
	...
	// draw fireball
	if ( !( pev->spawnflags & SF_ENVEXPLOSION_NOFIREBALL ) && CVAR_GET_FLOAT( "sv_explosion_display" ) )
	{
	...
	// draw sparks
	if ( !( pev->spawnflags & SF_ENVEXPLOSION_NOSPARKS ) && CVAR_GET_FLOAT( "sv_explosion_display" ) )
	{
