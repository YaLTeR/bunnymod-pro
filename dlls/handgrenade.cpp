...
void CHandGrenade::Precache( void )
{
	...
	m_usFireGrenade = PRECACHE_EVENT(1, "events/handgrenade.sc");
	/*
	int flags;
	...
	PLAYBACK_EVENT_FULL( flags, m_pPlayer->edict(), m_usFireGrenade, 0, (float *)&g_vecZero, (float *)&g_vecZero, m_flStartThrow, 0.0, 0, 0, 0, 0);*/
}
...
void CHandGrenade::PrimaryAttack()
{
	if ( !m_flStartThrow && m_pPlayer->m_rgAmmo[ m_iPrimaryAmmoType ] > 0 )
	{
		...
		PLAYBACK_EVENT( flags, m_pPlayer->edict(), m_usFireGrenade);

		m_flTimeWeaponIdle = UTIL_WeaponTimeBase() + 0.5;
	}
}

// This function is called when the +attack is RELEASED.
