...
cvar_t sv_trigger_changelevel_color = { "sv_trigger_changelevel_color", "0 255 0", FCVAR_SERVER };
cvar_t sv_trigger_transition_display = { "sv_trigger_transition_display", "0", FCVAR_SERVER };
cvar_t sv_trigger_transition_color = { "sv_trigger_transition_color", "0 255 255", FCVAR_SERVER };
cvar_t sv_trigger_hurt_display = { "sv_trigger_hurt_display", "0", FCVAR_SERVER };
cvar_t sv_trigger_hurt_color = { "sv_trigger_hurt_color", "255 0 0", FCVAR_SERVER };
cvar_t sv_trigger_push_display = { "sv_trigger_push_display", "0", FCVAR_SERVER };
cvar_t sv_trigger_push_color = { "sv_trigger_push_color", "0 0 255", FCVAR_SERVER };
cvar_t sv_trigger_once_display = { "sv_trigger_once_display", "0", FCVAR_SERVER };
cvar_t sv_trigger_once_color = { "sv_trigger_once_color", "255 255 0", FCVAR_SERVER };
cvar_t sv_trigger_multiple_display = { "sv_trigger_multiple_display", "0", FCVAR_SERVER };
cvar_t sv_trigger_multiple_color = { "sv_trigger_multiple_color", "255 128 0", FCVAR_SERVER };
cvar_t sv_trigger_teleport_display = { "sv_trigger_teleport_display", "0", FCVAR_SERVER };
cvar_t sv_trigger_teleport_color = { "sv_trigger_teleport_color", "255 0 255", FCVAR_SERVER };

cvar_t sv_info_landmark_display = { "sv_info_landmark_display", "0", FCVAR_SERVER };
cvar_t sv_info_landmark_model = { "sv_info_landmark_model", "models/w_battery.mdl", FCVAR_SERVER };
...
void GameDLLInit( void )
{
	...
	CVAR_REGISTER (&sv_trigger_transition_display);
	CVAR_REGISTER (&sv_trigger_transition_color);
	CVAR_REGISTER (&sv_trigger_hurt_display);
	CVAR_REGISTER (&sv_trigger_hurt_color);
	CVAR_REGISTER (&sv_trigger_push_display);
	CVAR_REGISTER (&sv_trigger_push_color);
	CVAR_REGISTER (&sv_trigger_once_display);
	CVAR_REGISTER (&sv_trigger_once_color);
	CVAR_REGISTER (&sv_trigger_multiple_display);
