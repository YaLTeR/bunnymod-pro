...
void CGauss::SecondaryAttack()
{
...
#ifndef CLIENT_DLL
		CLIENT_COMMAND(m_pPlayer->edict(), "hud_gaussboost_disable\n");
#else
	...
	if ( g_pGameRules->IsMultiplayer() )
		...
		// MrBozo: sound is bugged, can't seem to be able fix it nor even simply stop it
		if ( m_iSoundState == SND_CHANGE_PITCH )
			PLAYBACK_EVENT_FULL( FEV_NOTHOST, m_pPlayer->edict(), m_usGaussSpin, 0.0, (float *)&g_vecZero, (float *)&g_vecZero, 0.0, 0.0, pitch, 0, 1, 0 );
